...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String PDSETTINGSNS = "http://schemas.android.com/apk/res-auto";
    ...
    public SeekBarPreferenceCham(Context context, AttributeSet attrs) {
        super(context, attrs);
        setLayoutResource(R.layout.seek_bar_preference_cham);
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, PDSETTINGSNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, PDSETTINGSNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(PDSETTINGSNS, "interval");
            if(newInterval != null)
